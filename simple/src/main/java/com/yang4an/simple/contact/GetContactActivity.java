...
import com.yang4an.simple.BaseActivity;
import com.yang4an.simple.BaseActivity2;
import com.yang4an.simple.MainActivity;
import com.yang4an.simple.R;
import com.yang4an.simple.splash.SplashActivity;

import java.util.ArrayList;

/**
 * author: create by yangfan on 2020/5/14 1:57 PM
 * email: yang4an@gmail.com
 * description:
 * version:
 */
public class GetContactActivity extends BaseActivity2 {
    ...
    private void initView() {
        ...
        getContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addPermissByPermissionList(GetContactActivity.this, permissList, PERMISS_CONTACT);
            }
        });
    }

    private void showContacts() {
        ArrayList<ContactBean> contacts = ContactUtils.getAllContacts(GetContactActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (hasAllGranted) { //同意权限做的处理,开启服务提交通讯录
            ...
            dealwithPermiss(GetContactActivity.this, permissions[0]);
        }
    ...
    public void dealwithPermiss(final Activity context, String permission) {
        if (!ActivityCompat.shouldShowRequestPermissionRationale(context, permission)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(GetContactActivity.this);
            builder.setTitle("操作提示")
                    ...
                    .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(GetContactActivity.this, "取消操作", Toast.LENGTH_SHORT).show();
                        }
                    }).show();
